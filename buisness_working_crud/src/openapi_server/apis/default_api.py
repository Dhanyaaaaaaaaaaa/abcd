...
from openapi_server.models.customers_customer_id_get404_response import CustomersCustomerIdGet404Response
...
@router.delete(
    ...
    responses={
        ...
        404: {"model": CustomersCustomerIdGet404Response, "description": "Customer not found"},
    },
    tags=["default"],
